...
def function(inputs, outputs, updates=None, givens=None):
    ...
    if isinstance(outputs, list):
        ...
        # initialize _Function with arguments = __init__(self, inputs, outputs.values, updates, givens)
        ...
        # lamda function invokes __call__ method = __call__(self, *args, **kwargs)
...
class _Function(object):
    ...
    # __call__ is called when the instance of the object is called
